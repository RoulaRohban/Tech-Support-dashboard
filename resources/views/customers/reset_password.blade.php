@extends('layouts.app')
@section('title','Reset Customer Password')
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Reset Customer Password</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('customers.reset_password', $customer->id) }}">
                            @csrf
                            @method('PUT')
